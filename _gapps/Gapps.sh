...
# Configuration
DIRsd=sdcard/MDZ18AA_1.5.16/2_GAPPS
...
chmod 00755 /system/app/{Bluetooth,Browser,Calendar,CaptivePortalLogin,CertInstaller,DocumentsUI,DownloadProviderUi,Gallery2,HTMLViewer,KeyChain,MiTVSettings2,SoundRecorder,UserDictionaryProvider}
chmod 00644 /system/app/{Bluetooth/Bluetooth.apk,Browser/Browser.apk,Calendar/Calendar.apk,CaptivePortalLogin/CaptivePortalLogin.apk,CertInstaller/CertInstaller.apk,DocumentsUI/DocumentsUI.apk,DownloadProviderUi/DownloadProviderUi.apk,Gallery2/Gallery2.apk,HTMLViewer/HTMLViewer.apk,KeyChain/KeyChain.apk,MiTVSettings2/MiTVSettings2.apk,SoundRecorder/SoundRecorder.apk,UserDictionaryProvider/UserDictionaryProvider.apk}
...
chmod 00755 /system/app/{NovaLauncher,VoiceControl}
chmod 00644 /system/app/{NovaLauncher/NovaLauncher.apk,VoiceControl/VoiceControl.apk}
echo "Apps for /system/app copied"

# Copying Google apps to priv-app
cp -r /$DIRsd/system/priv-app/* /system/priv-app
chmod 00755 /system/priv-app/{GmsCore,GoogleLoginService,GoogleServicesFramework,Phonesky}
chmod 00644 /system/priv-app/{GmsCore/GmsCore.apk,GoogleLoginService/GoogleLoginService.apk,GoogleServicesFramework/GoogleServicesFramework.apk,Phonesky/Phonesky.apk}
...
echo "Modified /system/build.prop for Gapps"

sync
echo "Google Gapps successfully installed"
